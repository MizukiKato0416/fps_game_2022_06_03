...
// コンストラクタ
//=============================================================================
CPresetEffect::CPresetEffect(PRIORITY priorty) : CObject(priorty)
{
	...
	string SecondTex)
{
	...
	m_EffectState3D[m_nEffectPattern3d].pos = pos;
...
{
	CPresetEffect *pPresetEffect = new CPresetEffect(CObject::PRIORITY::EFFECT3D);
